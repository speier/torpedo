 ...
 * if unable to resolve the filename it will call the `fallback` function where you can return your own filename
 * finally it will call the `done` callback function when iterated over all require calls found.
 *
...
exports.visit = function(request, iterator, done, fallback, parent) {
  ...
  // skip the the requested file if it is a json but not package json
